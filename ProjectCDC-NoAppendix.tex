\documentclass[ProjectCDC]{subfiles}
% WARNING: AuCTeX local variables only get reset when file is loaded
% and differ between this file and ProjectCDC.tex
...
\onlyinsubfile{\externaldocument{ProjectCDC}} % Get xrefs -- esp to appendix -- from main file; only works properly if main file has already been compiled;
